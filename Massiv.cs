    ...
    static void Main(string[] args)
        {
            ...
            int[,] c = new int[3, 3] {{ 2, 3, 4 },{ 4, 9, 16 },{ 8, 27, 64 } };
            ...
            d[2] = new double[4] { Math.Log10(1), Math.Log10(10), Math.Log10(100), Math.Log10(1000)};//логарифм по основанию 10 чисел 1, 10, 100 и 1000

            // массивы для заданий 5 и 6.
            int[] array = { 1, 2, 3, 4, 5 };
            int[] array2 = { 7, 8, 9, 10, 11, 12, 13 };
            Array.Copy(sourceArray: array, sourceIndex: 0, destinationArray: array2, destinationIndex: 0, length: 3); // новая строка массива копируется в массив 2, место вставки 7 индекс
